...
access_schema = 'ssh'
# path_to_rp_config_file = os.path.abspath(os.path.join(os.getcwd(),
#                                                       '../src/radical/pilot/configs/resource_%s.json' %
#                                                       resource_name.split('.')[0]
#                                                       ))

path_to_rp_config_file = './test_issue_1514/config.json'
