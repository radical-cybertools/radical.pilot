...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'srcfolder', help='Folder which contains the files to be transfered')
    parser.add_argument(
        'resource', help="Target Resource that support GSISFTP")
    parser.add_argument(
        'tgtfolder', help="Target folder. Should be the whole path.")
    parser.add_argument('--tar', help='Transfer without tarball or with',
