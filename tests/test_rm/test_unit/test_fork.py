...
def test_configure(mocked_init, mocked_raise_on,mocked_multiprocessing_cpu_count):
    component = Fork()
...
def test_configure_error(mocked_init, mocked_raise_on,mocked_multiprocessing_cpu_count):
