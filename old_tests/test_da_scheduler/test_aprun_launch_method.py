...
class TestAPRUNlaunchMethod(tasktest.TestCase):
...
if __name__ == '__main__':
    ...
    suite = tasktest.TestLoader().loadTestsFromTestCase(TestAPRUNlaunchMethod)
    tasktest.TextTestRunner(verbosity=3).run(suite)
