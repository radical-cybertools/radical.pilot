...
.. code-block:: bash
    ...
    curl --insecure -Os https://raw.github.com/saga-project/sinon/devel/examples/tutorial/mandelbrot/mandelbrot.py
...
In your ``$HOME`` directory, open a new file sinon_mandelbrot.py with your 
favorite editor and paste the following content:

.. literalinclude:: ../../../examples/tutorial/mandelbrot/sinon_mandelbrot.py
