...
#import sinon
version = 1 #sinon.version
# The full version, including alpha/beta/rc tags.
release = 1 #sinon.version
...
texinfo_documents = [
  ('index', 'SAGA-Pilot', u'SAGA-Pilot Documentation',
   u'The SAGA-Pilot Project', 'SAGA-Pilot', 'One line description of project.',
   'Miscellaneous'),
]
