class TAFKAP_StorageResource(object):
    ...
    * Available
    ...
    def create_tfc(self, names):
        """Create an "empty" TFC on this TSR to be used as the output of a CU.
        """
        pass
...
class TAFKAP_FileContainer(object):
    """TAFKAP File Container (TFC)
       ...
       - A TFC is a logical container for a set of files.
       - Access to a TFC is atomic: it starts "empty" and is "filled" by either an "import" or by the output of a CU.
       - The total content of the TFC can be stored on one or more TSR.
