...
import multiprocessing  # to find the number of the cores.
...
if __name__ == "__main__":
    ...
    try:
      ...
      # pdesc.project  = 'TG-MCB090174'
        pdesc.runtime  = 10
        pdesc.cores    = multiprocessing.cpu_count()  # use all cores
        ...
        for i in range(pdesc.cores):
            ...
            cudesc.pre_exec = ["virtualenv ./ve", "source ./ve/bin/activate",
                               "pip install Pillow"]
          ...
          #                    "source ./ve/bin/activate", "pip install Pillow"]
            ...
            cudesc.arguments      = ['mandel_lines.py', imgX, imgY, xBeg, xEnd,
                                     yBeg, yEnd, pdesc.cores, i]
