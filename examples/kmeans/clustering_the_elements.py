...
if __name__ == "__main__":
    ...
    # here we classify in which centroid each element belongs to and add it 
    # to the sum of the coordinates of each centroid to the sum_of_centroids 
    # list. And keep the number of the elements that belong to each centroid.
    # The right element is the one that is closer to the centroid using the 
