...
virtenv_activate()
{
    ...
    source activate $virtenv/ #Activate VE
...
virtenv_create()
{
    ...
    #Creation of VE. Needs to change for Anaconda
    ...
    #    BOOTSTRAP_CMD="$PYTHON virtualenv-1.9/virtualenv.py $virtenv" #This must be the creation of the VE
    #fi
...
contains $CLEANUP 'v' && rm -r "$VIRTENV/" # FIXME: in what cases?How about Anaconda cases?
