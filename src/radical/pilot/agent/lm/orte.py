...
class ORTE(LaunchMethod):
    ...
    EXPORT_ENV_VARIABLES = [
        ...
        'COMPILER_PATH',
        'COOLVERS',
        'COOL_DISABLE_CORALCONNECTIONPOOLCLEANUP',
        'CORALVERS',
        'CORAL_AUTH_PATH',
        'CORAL_DBLOOKUP_PATH',
        'DATAPATH',
        'DAVID_HOME',
        'DAWN_BSD_UNIX_DOMAIN',
        'DAWN_GUI_ALWAYS',
        'DAWN_HOME',
        'DBRELEASE',
        'DBRELEASE_REQUESTED',
