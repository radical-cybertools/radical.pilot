...
class ORTELib(LaunchMethod):
    ...
    # --------------------------------------------------------------------------
    #
    # NOTE: ORTE_LIB LaunchMethod relies on the ORTE LaunchMethod's
    #       rm_config_hook and rm_shutdown_hook. These are "always" called,
    #       as even in the ORTE_LIB case we use ORTE for the sub-agent launch.
    #
    @classmethod
