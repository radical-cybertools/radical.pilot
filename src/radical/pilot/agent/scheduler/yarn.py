...
class Yarn(AgentSchedulingComponent):
    ...
    def _configure(self):
        ...
        self._log.info('Checking rm_ip %s' % self._rm_ip
        ...
        max_num_app = yarn_schedul_json['scheduler']['schedulerInfo']\
                                       ['queues']['queue'][0]['maxApplications']
        num_app     = yarn_schedul_json['scheduler']['schedulerInfo']\
                                       ['queues']['queue'][0]['numApplications']
