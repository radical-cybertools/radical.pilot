...
# ------------------------------------------------------------------------------
#
class Task (Attributes) :
    """ 
    Base class for DataTask and Task.
    """
    ...
    def wait (self, state=[DONE, FAILED, CANCELED], timeout=None) :
        ...
        Block until the task reaches the specified state, or timeout, whichever
    ...
    def cancel (self) :
        ...
        Move the task into Canceled state -- unless it it was in a final state,
